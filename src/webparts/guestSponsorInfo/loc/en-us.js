...
define([], function() {
  return {
    ...
    "WelcomeDialogSetupGuideNote": "These steps are a quick-start shortcut. Before running any script, read the setup guide to understand what each command does.",
    ...
    "WelcomeDialogConnectApiIntro": "Enter the connection details for your Guest Sponsor API. You can skip for now and add them later in the web part settings.",
    "WelcomeDialogUrlHintLabel": "Where to find the URL?",
    "WelcomeDialogUrlHintBody": "Copy the Function App URL from the Azure portal after deployment. Go to your Function App → Overview → Default domain.",
    ...
    "WelcomeDialogDoneApiSkippedBody": "No credentials entered yet. To finish setup: open the web part settings, enter the Base URL and Client ID under Guest Sponsor API, and save the page.",
