...
define([], function() {
  return {
    ...
    "WelcomeDialogSetupIntro": "Choose how visitors should see the web part. The editor preview stays the same — these options control the live page and can be changed later in settings.",
