...
define([], function() {
  return {
    ...
    "FunctionClientIdFieldLabel": "Guest Sponsor API client-ID (app-registratie)",
    "ProxyStatusChecking": "Guest Sponsor API controleren…",
    "ProxyStatusOk": "Guest Sponsor API bereikbaar",
    "ProxyStatusError": "Guest Sponsor API niet bereikbaar",
