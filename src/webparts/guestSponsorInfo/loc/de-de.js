...
define([], function() {
  return {
    ...
    "MockModePlaceholder": "Guest Sponsor Info — Demo-Modus aktiv. Wechseln Sie in den Anzeigemodus, um die Testdaten zu sehen.",
    ...
    "WelcomeDialogSetupGuideNote": "Diese Schritte sind eine Abkürzung. Lies die Einrichtungsanleitung, bevor du Skripte ausführst — damit du verstehst, was jeder Befehl tut.",
    ...
    "WelcomeDialogConnectApiIntro": "Gib die Verbindungsdaten für deine Guest Sponsor API ein. Du kannst diesen Schritt auch überspringen und sie später in den Web-Part-Einstellungen ergänzen.",
    "WelcomeDialogUrlHintLabel": "Wo finde ich die URL?",
    "WelcomeDialogUrlHintBody": "Kopiere die Function App-URL nach der Bereitstellung aus dem Azure-Portal. Gehe zu deiner Function App → Übersicht → Standarddomäne.",
    ...
    "WelcomeDialogDoneApiSkippedBody": "Es wurden noch keine Zugangsdaten eingegeben. Um die Einrichtung abzuschließen: Öffne die Web-Part-Einstellungen, gib Base-URL und Client-ID unter Guest Sponsor API ein und speichere die Seite.",
