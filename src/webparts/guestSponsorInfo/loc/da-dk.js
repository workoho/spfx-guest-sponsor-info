define([], function() {
  return {
    ...
    "GuestNotificationsGroupHint": "Styr hvilke informationsmeddelelser der vises til gæstebrugere. Alle meddelelser er aktiveret som standard.",
    ...
    "UseInformalAddressHint": "Påvirker statusbeskeder og bannere, der henvender sig direkte til gæstebrugeren i hele sætninger (f.eks. fejlbeskeder, Teams-adgangsbesked).",
  ...
  "FunctionGroupName": "Azure-funktion",
    ...
    "AddressMapProviderHint": "For at kortet kan finde placeringen, skal du aktivere mindst by eller land sammen med en del af adressen.",
    "CityFieldLabel": "By",
