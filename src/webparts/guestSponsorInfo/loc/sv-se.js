...
define([], function() {
  return {
    ...
    "FunctionUrlFieldLabel": "Guest Sponsor API bas-URL",
    "FunctionClientIdFieldLabel": "Guest Sponsor API klient-ID (appregistrering)",
    "ProxyStatusChecking": "Kontrollerar Guest Sponsor API…",
    "ProxyStatusOk": "Guest Sponsor API nåbar",
    "ProxyStatusError": "Guest Sponsor API inte nåbar",
